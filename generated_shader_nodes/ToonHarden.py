...
class ShaderNodeToonHarden(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        Size_socket.max_value = 0.9990000128746033
        ...
        Smooth_socket.subtype = "NONE"
            White_Level_socket = nt.interface.new_socket(
                name="White Level",
                in_out="INPUT",
                socket_type="NodeSocketFloat"
            )
        
        White_Level_socket.default_value = 1.0
        White_Level_socket.min_value = 0.0
        White_Level_socket.max_value = 1.0
        White_Level_socket.subtype = "NONE"
        ...
        Soft_Shading_Fac_socket.default_value = 1.0
        ...
        Group_Input_002.location = (363.777587890625, 99.21178436279297)
        ...
        Math_001.inputs["Value"].default_value = 1.0
        Math_001.inputs["Value"].default_value = 0.5
        Group_Input = nt.nodes.new("NodeGroupInput")
        Group_Input.location = (-791.6150512695312, -184.79843139648438)
        ...
        nt.links.new(Math_001.outputs["Value"], Map_Range_001.inputs["From Min"])
        nt.links.new(Group_Input.outputs["White Level"], Reroute_002.inputs["Input"])
        ...
        nt.links.new(Group_Input_002.outputs["Soft Shading Fac"], Mix.inputs["Factor"])
        nt.links.new(Mix.outputs["Result"], Group_Output.inputs["Shading"])
        nt.links.new(Map_Range.outputs["Result"], Mix.inputs["A"])
        nt.links.new(Group_Input_002.outputs["Shading"], Mix.inputs["B"])
