...
class ShaderNodeFaceNormalBuilder(ShaderNode):
    bl_label = "Face Normal Builder"
    bl_icon = "NONE"
    ...
    def createNodetree(self, name):
        ...
        Face_Value_socket.subtype = "NONE"
            Face_OS-Vector_socket = nt.interface.new_socket(
                name="Face OS-Vector",
                in_out="OUTPUT",
                socket_type="NodeSocketVector"
            )
        
        Face_OS-Vector_socket.default_value = (0.0, 0.0, 0.0)
        Face_OS-Vector_socket.subtype = "NONE"
        ...
        Group_Output.location = (1063.715576171875, 404.63177490234375)
        ...
        Reroute_026.location = (967.9348754882812, 348.2297668457031)
        Geometry = nt.nodes.new("ShaderNodeNewGeometry")
        Geometry.location = (-1073.525634765625, 100.34602355957031)
        ...
        Group_003.location = (-1074.274658203125, 205.5802001953125)
        # Create links
        ...
        nt.links.new(Reroute_026.outputs["Output"], Group_Output.inputs["Face OS-Vector"])
        ...
        nt.links.new(Group_001.outputs["Face To X"], Group_Output.inputs["Face To X"])
        nt.links.new(Group_001.outputs["Face To Y"], Group_Output.inputs["Face To Y"])
        nt.links.new(Geometry.outputs["Normal"], Group_001.inputs["Normal"])
        nt.links.new(Group_003.outputs["Main Light Vector"], Group_001.inputs["Light Dir"])