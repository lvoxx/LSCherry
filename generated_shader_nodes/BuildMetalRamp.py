...
class ShaderNodeBuildMetalRamp(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        Mix_1_socket.default_value = 0.5800000429153442
        Mix_1_socket.min_value = 0.0
        Mix_1_socket.max_value = 1000.0
        ...
        Mix_2_socket.default_value = 0.800000011920929
        Mix_2_socket.min_value = 0.0
        Mix_2_socket.max_value = 1000.0
        ...
        Fresnel_002.inputs["Normal"].default_value = (0.0, 0.0, 0.0)
        ...
        Fresnel_001.inputs["Normal"].default_value = (0.0, 0.0, 0.0)
        ...
        Group_Input.location = (-846.0470581054688, -89.17237091064453)
        ...
        Group_Output.location = (1061.19580078125, 363.1112976074219)
        ...
        Frame_004.location = (307.8115234375, 474.3560485839844)
        # Create links
