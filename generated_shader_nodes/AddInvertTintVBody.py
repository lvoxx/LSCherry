...
class ShaderNodeAddInvertTintVBody(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        Group_Output.location = (1970.76904296875, 834.9585571289062)
        ...
        Group_Input_004.location = (369.0453796386719, -299.6425476074219)
        ...
        Math_001.inputs["Value"].default_value = 1.5
        Math_001.inputs["Value"].default_value = 0.5
        Frame_003 = nt.nodes.new("NodeFrame")
        Frame_003.location = (1394.435791015625, 820.0762939453125)
        Group_Input_005 = nt.nodes.new("NodeGroupInput")
        Group_Input_005.location = (-1100.95947265625, -53.728294372558594)
        # Create links
