...
class ShaderNodeDefault_Attribute__Fac(ShaderNode):
    bl_idname = 'ShaderNodeDefault_Attribute__Fac'
    bl_label = "Default Attribute: Fac"
    bl_icon = "NODETREE"
    ...
    def createNodetree(self, name):
        ...
        nt.description = 'Default Attribute: Fac'
