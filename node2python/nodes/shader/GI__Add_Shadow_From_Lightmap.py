...
class ShaderNodeGI__Add_Shadow_From_Lightmap(ShaderNode):
    bl_idname = 'ShaderNodeGI__Add_Shadow_From_Lightmap'
    bl_label = "GI: Add Shadow From Lightmap"
    bl_icon = "NODETREE"
    ...
    def createNodetree(self, name):
        ...
        nt.description = 'GI: Add Shadow From Lightmap'
