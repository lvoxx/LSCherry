...
class ShaderNodeHSR__Add_Outline_From_Lightmap(ShaderNode):
    bl_idname = 'ShaderNodeHSR__Add_Outline_From_Lightmap'
    bl_label = "HSR: Add Outline From Lightmap"
    bl_icon = "NODETREE"
    ...
    def createNodetree(self, name):
        ...
        nt.description = 'HSR: Add Outline From Lightmap'
