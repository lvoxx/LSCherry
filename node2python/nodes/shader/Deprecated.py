...
class ShaderNodeDeprecated(ShaderNode):
    bl_idname = 'ShaderNodeDeprecated'
    bl_label = "Deprecated"
    bl_icon = "NODETREE"
    ...
    def createNodetree(self, name):
        ...
        nt.description = 'Deprecated'

        # Create output sockets
        nt.interface.new_socket('Deprecated', in_out='OUTPUT', socket_type='NodeSocketShader')
        nt.interface.new_socket('USE NEW NODE BELOW INSTEAD', in_out='OUTPUT', socket_type='NodeSocketShader')

        # Create input sockets
        nt.interface.new_socket('Deprecated', in_out='INPUT', socket_type='NodeSocketShader')
        nt.interface.new_socket('USE NEW NODE BELOW INSTEAD', in_out='INPUT', socket_type='NodeSocketShader')
    ...
    def rebuildNodetree(self, context):
        ...
        Frame.label = "⚠️ **Deprecated**: This package will be removed"
        Frame.name = "Frame"
