...
class ShaderNodeGI__Seperate_Head_Colormap(ShaderNode):
    bl_idname = 'ShaderNodeGI__Seperate_Head_Colormap'
    bl_label = "GI: Seperate Head Colormap"
    bl_icon = "NODETREE"
    ...
    def createNodetree(self, name):
        ...
        nt.description = 'GI: Seperate Head Colormap'
