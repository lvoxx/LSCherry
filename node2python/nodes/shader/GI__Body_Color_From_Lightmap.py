...
class ShaderNodeGI__Body_Color_From_Lightmap(ShaderNode):
    bl_idname = 'ShaderNodeGI__Body_Color_From_Lightmap'
    ...
    def createNodetree(self, name):
        ...
        nt.description = 'GI: Body Color From Lightmap'
    ...
    def rebuildNodetree(self, context):
        ...
        Frame.label = "Skip Map 0, its base"
        Frame.name = "Frame"
