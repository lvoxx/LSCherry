...
class ShaderNodeHI3__Add_Color_From_Colormap(ShaderNode):
    bl_idname = 'ShaderNodeHI3__Add_Color_From_Colormap'
    bl_label = "HI3: Add Color From Colormap"
    bl_icon = "NODETREE"
    ...
    def createNodetree(self, name):
        ...
        nt.description = 'HI3: Add Color From Colormap'
