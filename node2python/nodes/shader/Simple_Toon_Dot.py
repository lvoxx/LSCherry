...
class ShaderNodeSimple_Toon_Dot(ShaderNode):
    bl_idname = 'ShaderNodeSimple_Toon_Dot'
    ...
    def createNodetree(self, name):
        ...
        nt.description = 'Simple Toon Dot'
    ...
    def rebuildNodetree(self, context):
        ...
        nt.links.new(Attribute.outputs[1], Group_002.inputs[1])
        nt.links.new(Mix.outputs[1], Group_002.inputs[3])
        nt.links.new(Group_002.outputs[1], GroupOutput.inputs[0])
