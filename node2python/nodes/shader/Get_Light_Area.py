...
class ShaderNodeGet_Light_Area(ShaderNode):
    bl_idname = 'ShaderNodeGet_Light_Area'
    ...
    def createNodetree(self, name):
        ...
        nt.description = 'Get Light Area'

        # Create output sockets
        nt.interface.new_socket('Fixed Shading', in_out='OUTPUT', socket_type='NodeSocketFloat')
