...
class ShaderNodeBuild_Metal_Ramp(ShaderNode):
    bl_idname = 'ShaderNodeBuild_Metal_Ramp'
    bl_label = "Build Metal Ramp"
    bl_icon = "NODETREE"

    def init(self, context):
        self.getNodetree(self.name + '_node_tree')
        self.inputs["Mix 1"].default_value = 0.5800000429153442
        self.inputs["Mix 2"].default_value = 0.800000011920929
    ...
    def createNodetree(self, name):
        ...
        nt.description = 'Build Metal Ramp'
        ...
        input_socket.default_value = 0.5800000429153442
    ...
    def rebuildNodetree(self, context):
        ...
        nt.links.new(GroupInput.outputs[1], Fresnel_002.inputs[0])
        nt.links.new(GroupInput.outputs[2], Fresnel.inputs[0])
        nt.links.new(GroupInput.outputs[3], Fresnel_001.inputs[0])
        ...
        nt.links.new(GroupInput.outputs[5], Reroute_002.inputs[0])
        nt.links.new(GroupInput.outputs[6], Reroute_004.inputs[0])
        ...
        nt.links.new(GroupInput.outputs[7], Reroute_010.inputs[0])
        ...
        # Set default values
        Fresnel_002.inputs[1].default_value = (0.0, 0.0, 0.0)
