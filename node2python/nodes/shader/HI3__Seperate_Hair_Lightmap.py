...
class ShaderNodeHI3__Seperate_Hair_Lightmap(ShaderNode):
    bl_idname = 'ShaderNodeHI3__Seperate_Hair_Lightmap'
    bl_label = "HI3: Seperate Hair Lightmap"
    bl_icon = "NODETREE"
    ...
    def createNodetree(self, name):
        ...
        nt.description = 'HI3: Seperate Hair Lightmap'
