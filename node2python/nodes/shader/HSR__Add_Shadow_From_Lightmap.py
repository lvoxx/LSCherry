...
class ShaderNodeHSR__Add_Shadow_From_Lightmap(ShaderNode):
    bl_idname = 'ShaderNodeHSR__Add_Shadow_From_Lightmap'
    bl_label = "HSR: Add Shadow From Lightmap"
    bl_icon = "NODETREE"
    ...
    def createNodetree(self, name):
        ...
        nt.description = 'HSR: Add Shadow From Lightmap'
