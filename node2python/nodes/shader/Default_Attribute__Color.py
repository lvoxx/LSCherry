...
class ShaderNodeDefault_Attribute__Color(ShaderNode):
    bl_idname = 'ShaderNodeDefault_Attribute__Color'
    ...
    def createNodetree(self, name):
        ...
        nt.description = 'Default Attribute: Color'
        ...
        input_socket = nt.interface.new_socket('Default', in_out='INPUT', socket_type='NodeSocketColor')
