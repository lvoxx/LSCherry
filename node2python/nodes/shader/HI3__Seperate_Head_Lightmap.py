...
class ShaderNodeHI3__Seperate_Head_Lightmap(ShaderNode):
    bl_idname = 'ShaderNodeHI3__Seperate_Head_Lightmap'
    bl_label = "HI3: Seperate Head Lightmap"
    bl_icon = "NODETREE"
    ...
    def createNodetree(self, name):
        ...
        nt.description = 'HI3: Seperate Head Lightmap'
