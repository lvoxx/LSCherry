...
class ShaderNodeGI__Add_Color_From_Colormap(ShaderNode):
    bl_idname = 'ShaderNodeGI__Add_Color_From_Colormap'
    bl_label = "GI: Add Color From Colormap"
    bl_icon = "NODETREE"
    ...
    def createNodetree(self, name):
        ...
        nt.description = 'GI: Add Color From Colormap'
