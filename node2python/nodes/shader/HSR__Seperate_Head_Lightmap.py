...
class ShaderNodeHSR__Seperate_Head_Lightmap(ShaderNode):
    bl_idname = 'ShaderNodeHSR__Seperate_Head_Lightmap'
    bl_label = "HSR: Seperate Head Lightmap"
    bl_icon = "NODETREE"
    ...
    def createNodetree(self, name):
        ...
        nt.description = 'HSR: Seperate Head Lightmap'
