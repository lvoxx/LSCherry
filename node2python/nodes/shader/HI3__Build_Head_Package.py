...
class ShaderNodeHI3__Build_Head_Package(ShaderNode):
    bl_idname = 'ShaderNodeHI3__Build_Head_Package'
    bl_label = "HI3: Build Head Package"
    bl_icon = "NODETREE"
    ...
    def createNodetree(self, name):
        ...
        nt.description = 'HI3: Build Head Package'
