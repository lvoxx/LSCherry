...
class ShaderNodeFace_Normal_Builder(ShaderNode):
    bl_idname = 'ShaderNodeFace_Normal_Builder'
    ...
    def createNodetree(self, name):
        ...
        nt.description = 'Face Normal Builder'

        # Create output sockets
        nt.interface.new_socket('Face Value', in_out='OUTPUT', socket_type='NodeSocketFloat')
        nt.interface.new_socket('Face OS-Vector', in_out='OUTPUT', socket_type='NodeSocketVector')
    ...
    def rebuildNodetree(self, context):
        ...
        nt.links.new(Group_001.outputs[5], GroupOutput.inputs[2])
        nt.links.new(Group_001.outputs[6], GroupOutput.inputs[3])
        nt.links.new(Geometry.outputs[1], Group_001.inputs[3])
        nt.links.new(Group_003.outputs[0], Group_001.inputs[1])
