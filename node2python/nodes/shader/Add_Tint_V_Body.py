...
class ShaderNodeAdd_Tint_V_Body(ShaderNode):
    bl_idname = 'ShaderNodeAdd_Tint_V_Body'
    ...
    def createNodetree(self, name):
        ...
        nt.description = 'Add Tint V-Body'
        ...
        input_socket = nt.interface.new_socket('Pattern', in_out='INPUT', socket_type='NodeSocketFloat')
        input_socket.default_value = 1.0
    ...
    def rebuildNodetree(self, context):
        ...
        nt.links.new(Mix_007.outputs[0], Mix_006.inputs[0])
